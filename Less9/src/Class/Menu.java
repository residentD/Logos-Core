...
public class Menu {
	...
	static void startCase(int menuCase) {
	...
	static void actions(int menuCase, String input) {
	 ...
	 * convert String - int
	 */
	private static int regInt(String inpSt) throws WrongMethodTypeException {
		if (inpSt.matches("[-+]?\\d+")) {
			return Integer.parseInt(inpSt);
		} else {
